...
  '/',
  '/index.html',
  '/app.js', // Contiene la lógica Y AHORA LAS RECETAS
  '/styles.css',
  '/manifest.json',
  // Eliminada la referencia a /recetas.js, ya que fue fusionado con app.js
];
...
            // Si falla, el Service Worker no se instalará; este fallo es ahora muy improbable.
        });
      })
  );
});
